...
pub(in crate::db::migrations) async fn create_geo_indexes(db: &DatabaseConnection) -> Result<()> {
    create_index(
        db,
        entities::geo_country_catalog::Entity,
        "idx_firewall_geo_country_catalog_code",
        Index::create()
    ...
    create_index(
        db,
        entities::geo_ip_list_state::Entity,
        "idx_firewall_geo_ip_list_states_country",
        Index::create()
    ...
    create_index(
        db,
        entities::geo_ip_prefix::Entity,
        "idx_firewall_geo_ip_prefixes_country",
        Index::create()
